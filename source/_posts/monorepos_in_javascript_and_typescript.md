...
在我们的例子中，monorepo由多个apps/packages共同工作组成。在后台，一个叫做workspaces的工具使我们能够创建一个文件夹结构，应用程序可以使用包作为依赖。在我们的示例中，我们使用[yarn workspaces][2]来完成我们的目标。也有一些替代品，如[npm workspaces][3]和[pnpm workspaces][4]。
